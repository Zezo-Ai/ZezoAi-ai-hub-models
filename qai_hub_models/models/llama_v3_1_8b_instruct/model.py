...
DEFAULT_CHECKPOINT = {Precision.w4a16: "llama31_ckpt_w4a16"}
...
class Llama3_1_8B(Llama3Base):
    ...
    def from_pretrained(
        ...
        host_device:
            The device on host machine. Can be cpu or CUDA enabled GPU.
        _skip_optimizations:
...
class Llama3_1_8B_QNN(Llama3Base_QNN):
    ...
    get_input_spec = staticmethod(Llama3_1_8B.get_input_spec)
