...
class Qwen2_5_7B(Qwen2Base):
    ...
    def from_pretrained(
        ...
        """
        Load a pre-trained Qwen 2.5 (7B) model via HuggingFace.
...
class Qwen2_5_7B_AIMETOnnx(Qwen2Base_AIMETOnnx):
    @classmethod
...
class Qwen2_5_7B_QNN(Qwen2Base_QNN):
    ...
    get_input_spec = staticmethod(Qwen2_5_7B.get_input_spec)
