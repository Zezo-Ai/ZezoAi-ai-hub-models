...
HF_REPO_NAME = "aisingapore/Llama-SEA-LION-v3.5-8B-R"
...
DEFAULT_CHECKPOINT = {Precision.w4a16: "llama_v3_1_sea_lion_3_5_8b_r_ckpt_w4a16"}


class Llama3_1_SEALION_3_5_8B_R(Llama3Base):
...
class Llama3_1_SEALION_3_5_8B_R_QNN(Llama3Base_QNN):
