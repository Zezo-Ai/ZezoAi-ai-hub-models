...
class Phi35Mini(Phi35Base):
    ...
    def from_pretrained(
        ...
        """
        Load a pre-trained Phi 3.5 (3.8B) model from Microsoft via HuggingFace.
        ...
        -------
        model : Self
            The pre-trained Phi 3.5 Mini model.
        """
        return cls(
...
class Phi35Mini_AIMETOnnx(Phi35Base_AIMETOnnx):
    def __init__(
    ...
    def from_pretrained(
        ...
        -------
        model : Self
            The quantized Phi 3.5 Mini model.
        """
...
class Phi35Mini_QNN(Phi35Base_QNN):
    ...
    get_input_spec = staticmethod(Phi35Mini.get_input_spec)
