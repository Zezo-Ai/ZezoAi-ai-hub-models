...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/detr_resnet101_dc5).
...
```bash
python -m qai_hub_models.models.detr_resnet101_dc5.demo { --quantize w8a16_mixed_int16 }
```
...
```bash
python -m qai_hub_models.models.detr_resnet101_dc5.export { --quantize w8a16_mixed_int16 }
```
