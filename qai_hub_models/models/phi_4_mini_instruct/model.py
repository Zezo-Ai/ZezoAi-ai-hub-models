...
HF_REPO_NAME = "microsoft/Phi-4-mini-instruct"
...
class Phi4Mini(Phi35Base):
    ...
    def from_pretrained(
        ...
        """
        Load a pre-trained Phi 4 mini model from Microsoft via HuggingFace.
        ...
        -------
        model : Self
            The pre-trained Phi 4 Mini model.
        """
        return cls(
    ...
    def get_output_names() -> list[str]:
        return Phi35Base._get_output_names(NUM_LAYERS)
    ...
    def get_input_spec(
        ...
        return Phi35Base._get_input_spec(
...
class Phi4Mini_AIMETOnnx(Phi35Base_AIMETOnnx):
    def __init__(
    ...
    def from_pretrained(
        ...
        -------
        model : Self
            The quantized Phi 4 Mini model.
        """
...
class Phi4Mini_QNN(Phi35Base_QNN):
    ...
    get_input_spec = staticmethod(Phi4Mini.get_input_spec)
