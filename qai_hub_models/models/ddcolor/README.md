# [DDColor: Colorize image from the black-and-white image](https://aihub.qualcomm.com/models/ddcolor)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/ddcolor).
...
```bash
python -m qai_hub_models.models.ddcolor.demo { --quantize w8a16, w8a8 }
```
...
```bash
python -m qai_hub_models.models.ddcolor.export { --quantize w8a16, w8a8 }
```
