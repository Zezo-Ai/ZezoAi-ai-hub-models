...
# [StereoNet: Real-time stereo matching network for disparity estimation](https://aihub.qualcomm.com/models/stereonet)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/stereonet).
...
```bash
python -m qai_hub_models.models.stereonet.demo
```
...
```bash
python -m qai_hub_models.models.stereonet.export
```
