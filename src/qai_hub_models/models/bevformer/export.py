...
from qai_hub_models.models.bevformer import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.bevformer.export` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models export bevformer` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
