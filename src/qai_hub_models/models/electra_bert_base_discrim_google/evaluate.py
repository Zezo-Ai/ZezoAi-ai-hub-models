...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.electra_bert_base_discrim_google.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate electra_bert_base_discrim_google` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
