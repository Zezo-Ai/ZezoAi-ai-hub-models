...
def test_create_genie_config() -> None:
    ...
    model_list = [f"qwen2_5_7b_instruct_part_{i}_of_4.bin" for i in range(1, 5)]
            ...
            "engine": {
                ...
                "model": {
                    ...
                    "binary": {
                        "version": 1,
                        "ctx-bins": [
                            "qwen2_5_7b_instruct_part_1_of_4.bin",
                            "qwen2_5_7b_instruct_part_2_of_4.bin",
                            "qwen2_5_7b_instruct_part_3_of_4.bin",
                            "qwen2_5_7b_instruct_part_4_of_4.bin",
                        ],
                    },
                },
            },
...
@pytest.mark.parametrize(
    ...
    [
        ("DEFAULT", "wikitext", 9.30, 0),
        ("DEFAULT", "tiny_mmlu", 0.65, 0),
        ("DEFAULT_UNQUANTIZED", "wikitext", 7.05, 0),
...
def test_demo_default_quantized(capsys: pytest.CaptureFixture[str]) -> None:
    cleanup()
    qwen2_5_7b_chat_demo(
        fp_model_cls=FP_Model,
