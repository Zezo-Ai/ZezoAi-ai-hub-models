...
DEFAULT_CHECKPOINT: dict[Precision, str] = {
    Precision.w4a16: "qwen38_w4a16_adascale",
}


class Qwen3_8B(Qwen3Base):
    ...
    def from_pretrained(
        ...
        """
        Load a pre-trained Qwen3-8B model via HuggingFace.
        ...
        -------
        model : Self
            The pre-trained Qwen3-8B model.
        """
...
class Qwen3_8B_QNN(Qwen3Base_QNN):
