...
from qai_hub_models.models.qwen3_8b import (
    MODEL_ID,
    FP_Model,
    Model,
    PositionProcessor,
...
from qai_hub_models.models.qwen3_8b.export import DEFAULT_EXPORT_DEVICE
from qai_hub_models.models.qwen3_8b.export import main as export_main
...
def test_create_genie_config() -> None:
    ...
    model_list = [f"qwen3_8b_part_{i}_of_4.bin" for i in range(1, 5)]
            ...
            "engine": {
                ...
                "model": {
                    ...
                    "binary": {
                        "version": 1,
                        "ctx-bins": [
                            "qwen3_8b_part_1_of_4.bin",
                            "qwen3_8b_part_2_of_4.bin",
                            "qwen3_8b_part_3_of_4.bin",
                            "qwen3_8b_part_4_of_4.bin",
                        ],
                    },
                },
            },
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("DEFAULT", "wikitext", 9.46, 0, marks=pytest.mark.nightly),
