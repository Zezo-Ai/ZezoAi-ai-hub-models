...
# Qwen3-4B-Instruct-2507 model configuration
NUM_LAYERS = 36
NUM_SPLITS = 4
...
DEFAULT_CHECKPOINT: dict[Precision, str] = {
    Precision.w4a16: "qwen34instruct2507_w4a16_adascale",
}


class Qwen3_4B_Instruct_2507(Qwen3Base):
    ...
    def from_pretrained(
        ...
        """
        Load a pre-trained Qwen3-4B-Instruct-2507 model via HuggingFace.
        ...
        -------
        model : Self
            The pre-trained Qwen3-4B-Instruct-2507 model.
        """
...
class Qwen3_4B_Instruct_2507_AIMETOnnx(Qwen3Base_AIMETOnnx):
    ...
    def from_pretrained(
        ...
        -------
        model : Self
            The quantized Qwen3-4B-Instruct-2507 model.
        """
