...
from qai_hub_models.models.smollm2_1_7b_it import DEFAULT_PRECISION, MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.smollm2_1_7b_it.export` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models export smollm2_1_7b_it` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
