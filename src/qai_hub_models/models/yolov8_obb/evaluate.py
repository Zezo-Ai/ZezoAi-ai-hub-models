...
from qai_hub_models.models.yolov8_obb import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.yolov8_obb.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate yolov8_obb` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
