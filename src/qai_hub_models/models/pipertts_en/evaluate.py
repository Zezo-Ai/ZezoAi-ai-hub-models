...
from qai_hub_models.models.pipertts_en import MODEL_ID, App, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.pipertts_en.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate pipertts_en` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
