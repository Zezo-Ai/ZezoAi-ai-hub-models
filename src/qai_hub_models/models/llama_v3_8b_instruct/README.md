...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/llama_v3_8b_instruct).
...
```
For llama_v3_8b_instruct, some additional functionality can be faster or is available
...
```bash
python -m qai_hub_models.models.llama_v3_8b_instruct.export --device "Samsung Galaxy S25 (Family)"
```
