...
from qai_hub_models.models.ffnet_54s import MODEL_ID, Model
from qai_hub_models.models.ffnet_54s import export as model_export_module
from qai_hub_models.models.ffnet_54s.export import (
    compile_model,
    export_model,
    inference_model,
    link_model,
