...
from qai_hub_models.models.detectron2_detection import MODEL_ID, App, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.detectron2_detection.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate detectron2_detection` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
