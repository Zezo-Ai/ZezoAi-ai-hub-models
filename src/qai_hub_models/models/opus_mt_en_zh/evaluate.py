...
from qai_hub_models.models.opus_mt_en_zh import MODEL_ID, App, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.opus_mt_en_zh.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate opus_mt_en_zh` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
