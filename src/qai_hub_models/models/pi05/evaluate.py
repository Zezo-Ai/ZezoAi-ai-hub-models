...
from qai_hub_models.models.pi05 import MODEL_ID, App, Model
...
DEFAULT_EVAL_DEVICE = "Dragonwing IQ-9075 EVK"
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.pi05.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate pi05` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
