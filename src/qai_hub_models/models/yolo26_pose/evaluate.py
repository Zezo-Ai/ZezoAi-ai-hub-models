...
from qai_hub_models.models.yolo26_pose import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.yolo26_pose.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate yolo26_pose` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
