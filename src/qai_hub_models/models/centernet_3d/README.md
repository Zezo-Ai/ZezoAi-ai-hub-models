...
This is based on the implementation of CenterNet-3D found [here](https://github.com/xingyizhou/CenterNet).
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/centernet_3d).
