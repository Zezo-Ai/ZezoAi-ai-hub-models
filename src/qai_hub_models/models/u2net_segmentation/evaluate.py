...
from qai_hub_models.models.u2net_segmentation import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.u2net_segmentation.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate u2net_segmentation` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
