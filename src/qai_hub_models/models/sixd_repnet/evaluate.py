...
from qai_hub_models.models.sixd_repnet import MODEL_ID, App, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.sixd_repnet.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate sixd_repnet` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
