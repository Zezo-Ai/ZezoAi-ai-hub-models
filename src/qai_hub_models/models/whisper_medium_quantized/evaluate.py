...
from qai_hub_models.models.whisper_medium_quantized import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.whisper_medium_quantized.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate whisper_medium_quantized` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
