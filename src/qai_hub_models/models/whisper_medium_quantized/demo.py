...
from qai_hub_models.models.whisper_medium_quantized.model import (
    WhisperMediumQuantized,
)
from qai_hub_models.utils.args import get_model_cli_parser


def hf_whisper_demo(
    model_cls: type[WhisperMediumQuantized], is_test: bool = False
) -> None:
...
def main(is_test: bool = False) -> None:
    hf_whisper_demo(WhisperMediumQuantized, is_test)
