...
from qai_hub_models.models.templates.qwen2.model import (
    Qwen2Base,
    Qwen2Base_AIMETOnnx,
    Qwen2Base_QNN,
...
class Qwen2VLTextBase(Qwen2Base):
    ...
    def monkey_patch(skip_optimizations: list[str] | None = None) -> None:
        ...
        """
        from qai_hub_models.models.templates.qwen2.model import Qwen2_Optimizations
        from qai_hub_models.models.templates.qwen2_vl.model_adaptations import (
            QCQwen2_5_VLMLP,
