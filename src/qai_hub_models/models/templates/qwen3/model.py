...
from qai_hub_models.models.templates.llama3.model import RopeEmbedding
...
class Qwen3Base_AIMETOnnx(LLM_AIMETOnnx):
    ...
    def _adapt_aimet_encodings(
        ...
        # templates/llama3/model.py for why this is needed.
...
#
# These mirror the Llama family bases in templates/llama3/model.py. The generic
# split/inference machinery lives in DynamicSplitPartBase /
# DynamicSplitCollectionBase (templates/llm/model.py); only the genuinely
