# [CenterNet-Pose: Human pose estimation](https://aihub.qualcomm.com/models/centernet_pose)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/centernet_pose).
...
```bash
python -m qai_hub_models.models.centernet_pose.export --device "Samsung Galaxy S25 (Family)"
```
