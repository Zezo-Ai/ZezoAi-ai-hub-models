...
from qai_hub_models.models.stable_diffusion_v1_5 import MODEL_ID, App, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.stable_diffusion_v1_5.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate stable_diffusion_v1_5` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
