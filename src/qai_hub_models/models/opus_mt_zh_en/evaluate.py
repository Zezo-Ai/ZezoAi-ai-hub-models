...
from qai_hub_models.models.opus_mt_zh_en import MODEL_ID, App, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.opus_mt_zh_en.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate opus_mt_zh_en` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
