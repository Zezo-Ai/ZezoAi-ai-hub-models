# [GKT: Construct a bird’s eye view from sensors mounted on a vehicle](https://aihub.qualcomm.com/models/gkt)
...
```bash
python -m qai_hub_models.models.gkt.demo { --quantize w8a16_mixed_fp16 }
```
...
```bash
python -m qai_hub_models.models.gkt.export --device "Samsung Galaxy S25 (Family)" { --quantize w8a16_mixed_fp16 }
```
