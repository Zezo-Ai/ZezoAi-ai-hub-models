...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/face_det_lite).
...
```bash
python -m qai_hub_models.models.face_det_lite.demo { --quantize w8a16_mixed_int16, w8a16, w8a8 }
```
...
```bash
python -m qai_hub_models.models.face_det_lite.export { --quantize w8a16_mixed_int16, w8a16, w8a8 }
```
