...
from qai_hub_models.models.maskrcnn import MODEL_ID, App, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.maskrcnn.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate maskrcnn` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
