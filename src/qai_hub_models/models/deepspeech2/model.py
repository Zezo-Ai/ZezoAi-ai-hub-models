...
from deepspeech_pytorch.model import BatchRNN, DeepSpeech
...
class DeepSpeech2(BaseModel):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Conv stack
        x, _ = self.model.conv(x, output_lengths)
        sizes = x.size()
    ...
    def _sample_inputs_impl(
        ...
        # Local import to avoid circular dependency: app.py imports LABELS/BLANK_IDX from model.py
    ...
    def get_input_spec(
        ...
        return InputSpec(input=((batch_size, num_frames, num_features), "float32"))
    ...
    def get_evaluator(self) -> BaseEvaluator:
        from qai_hub_models.models.deepspeech2.evaluator import (
            DeepSpeech2Evaluator,
        )

        return DeepSpeech2Evaluator(self)
