...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/pointnet).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download PointNet:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info PointNet

# Print performance and accuracy metrics
qai-hub-models perf PointNet
qai-hub-models numerics PointNet

# Download a ready-to-deploy asset
qai-hub-models fetch PointNet --runtime tflite --precision float
```
...
qai-hub-models install pointnet
```
...
```bash
qai-hub-models export pointnet
```
