...
from qai_hub_models.models.yolov11_pose import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.yolov11_pose.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate yolov11_pose` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
