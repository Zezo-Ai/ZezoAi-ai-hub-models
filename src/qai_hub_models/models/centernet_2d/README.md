# [CenterNet-2D: Object Detection](https://aihub.qualcomm.com/models/centernet_2d)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/centernet_2d).
...
pip install "qai-hub-models[centernet-2d]"
```
...
```bash
python -m qai_hub_models.models.centernet_2d.demo
```
...
```bash
python -m qai_hub_models.models.centernet_2d.export --device "Samsung Galaxy S25 (Family)"
```
