...
from qai_hub_models.models.qwen2_5_1_5b_instruct.export import DEFAULT_EXPORT_DEVICE
...
def test_create_genie_config() -> None:
    ...
    model_list = [f"qwen2_5_1_5b_instruct_part_{i}_of_4.bin" for i in range(1, 5)]
            ...
            "engine": {
                ...
                "model": {
                    ...
                    "binary": {
                        "version": 1,
                        "ctx-bins": [
                            "qwen2_5_1_5b_instruct_part_1_of_4.bin",
                            "qwen2_5_1_5b_instruct_part_2_of_4.bin",
                            "qwen2_5_1_5b_instruct_part_3_of_4.bin",
                            "qwen2_5_1_5b_instruct_part_4_of_4.bin",
                        ],
                    },
                },
            },
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("DEFAULT", "mmlu", 0.554, 1000),
        ("DEFAULT_UNQUANTIZED", "wikitext", 10.324, 0),
        ("DEFAULT_UNQUANTIZED", "tiny_mmlu", 0.61, 0),
    ],
)
def test_evaluate(
    checkpoint: str,
    ...
    log_evaluate_test_result(
        model_name=MODEL_ID,
        checkpoint="DEFAULT_W4" if checkpoint == "DEFAULT" else checkpoint,
        metric=task,
        value=actual_metric,
    )
