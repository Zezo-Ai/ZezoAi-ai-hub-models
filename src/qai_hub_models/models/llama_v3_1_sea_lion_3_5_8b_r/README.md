...
If you are quantizing your own variant of llama_v3_1_sea_lion_3_5_8b_r, a dedicated CUDA enabled
...
```bash
python -m qai_hub_models.models.llama_v3_1_sea_lion_3_5_8b_r.export --device "Samsung Galaxy S25 (Family)"
```
