...
from qai_hub_models.models.whisper_base import MODEL_ID, App, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    ...
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.whisper_base.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate whisper_base` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
