...
This is based on the implementation of OpusMT-En-Es found [here](https://github.com/Helsinki-NLP/Opus-MT).
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/opus_mt_en_es).
...
```bash
python -m qai_hub_models.models.opus_mt_en_es.export --device "Samsung Galaxy S25 (Family)"
```
