# [ACT: Action Chunking with Transformers](https://aihub.qualcomm.com/models/act)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/act).

Qualcomm AI Hub Models uses [Qualcomm AI Hub Workbench](https://workbench.aihub.qualcomm.com) to compile, profile, and evaluate this model. [Sign up](https://myaccount.qualcomm.com/signup) to run these models on a hosted Qualcomm® device.

## Quick Start

Use our lightweight command-line interface to inspect and download ACT:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info ACT

# Print performance and accuracy metrics
qai-hub-models perf ACT
qai-hub-models numerics ACT

# Download a ready-to-deploy asset
qai-hub-models fetch ACT --runtime tflite --precision float
```
...
```bash
qai-hub-models export act --target-runtime tflite --precision float
```
