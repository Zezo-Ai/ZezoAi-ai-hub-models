...
from qai_hub_models.models.conditional_detr_resnet50 import MODEL_ID, Model
from qai_hub_models.models.conditional_detr_resnet50 import (
    export as model_export_module,
)
from qai_hub_models.models.conditional_detr_resnet50.export import (
    compile_model,
    export_model,
    inference_model,
    link_model,
