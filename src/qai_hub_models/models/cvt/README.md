# [CVT: Construct a map view from sensors mounted on a vehicle](https://aihub.qualcomm.com/models/cvt)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/cvt).
...
```bash
python -m qai_hub_models.models.cvt.export --device "Samsung Galaxy S25 (Family)" { --quantize w8a16_mixed_fp16 }
```
