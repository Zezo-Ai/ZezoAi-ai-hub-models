...
Use our lightweight command-line interface to inspect and download HuggingFace-WavLM-Base-Plus:

```bash
pip install qai_hub_models_cli # (the CLI is also available with the qai-hub-models package)

# Inspect the model and list the available download options
qai-hub-models info HuggingFace-WavLM-Base-Plus

# Print performance and accuracy metrics
qai-hub-models perf HuggingFace-WavLM-Base-Plus
qai-hub-models numerics HuggingFace-WavLM-Base-Plus

# Download a ready-to-deploy asset
qai-hub-models fetch HuggingFace-WavLM-Base-Plus --runtime qnn_context_binary --precision float
```
