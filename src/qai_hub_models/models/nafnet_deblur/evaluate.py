...
from qai_hub_models.models.nafnet_deblur import MODEL_ID, Model
...
def main(args: argparse.Namespace | None = None) -> None:
    if args is None:
        warnings.warn(
            "Running `python -m qai_hub_models.models.nafnet_deblur.evaluate` is "
            "deprecated and will be removed in a future release. "
            "Use `qai-hub-models evaluate nafnet_deblur` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
