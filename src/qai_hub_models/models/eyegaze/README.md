# [EyeGaze: Eye gaze estimation from cropped eye images](https://aihub.qualcomm.com/models/eyegaze)
...
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/eyegaze).
...
```bash
python -m qai_hub_models.models.eyegaze.demo { --quantize w8a16 }
```
...
```bash
python -m qai_hub_models.models.eyegaze.export { --quantize w8a16 }
```
