...
Use our lightweight command-line interface to inspect and download Whisper-Small:
...
qai-hub-models numerics Whisper-Small
...
```bash
qai-hub-models export whisper_small --target-runtime qnn_context_binary --precision float --device "Samsung Galaxy S25 (Family)"
```
