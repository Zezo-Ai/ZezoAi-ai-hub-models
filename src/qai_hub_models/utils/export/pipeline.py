...
def export_model(
    ...
    **additional_model_kwargs: Any,
    ...
    fetch_static_assets
        If set, known assets are fetched from the given version rather than
        re-computing them. Pass "latest" or "v<version>".
    zip_assets
    ...
    **additional_model_kwargs
    ...
    # No-hub shortcut — return cached static assets.
