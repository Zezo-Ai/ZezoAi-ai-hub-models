...
from qai_hub_models.models.llama_v3_1_8b_instruct import Model
from qai_hub_models.models.llama_v3_1_8b_instruct.demo import llama_3_1_8b_chat_demo
from qai_hub_models.models.llama_v3_1_8b_instruct.model import (
    MODEL_ID,
    FPSplitModelWrapper,
    Llama3_1_8B_PreSplit,
    Llama3_1_8B_QuantizablePreSplit,
...
@pytest.mark.parametrize(
    ...
    [
        ("DEFAULT_W4A16", "wikitext", 7.89, 0),
        ("DEFAULT_W4A16", "tiny_mmlu", 0.57, 0),
        ("DEFAULT_UNQUANTIZED", "wikitext", 6.75, 0),
...
def test_evaluate(
    ...
    test.run_llm_evaluate_test(
        ...
        quantized_presplit_cls=Llama3_1_8B_QuantizablePreSplit,
        fp_presplit_cls=Llama3_1_8B_PreSplit,
