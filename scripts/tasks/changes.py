...
MANUAL_EDGES = {
    ...
    "src/qai_hub_models/configs/devices_and_chipsets_yaml.py": REPRESENTATIVE_EXPORT_FILES,
    ...
    "src/qai_hub_models/configs/numerics_yaml.py": REPRESENTATIVE_EXPORT_FILES,
